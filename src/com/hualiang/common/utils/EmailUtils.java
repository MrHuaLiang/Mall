...
public class EmailUtils {
    ...
    private static MimeMessage createMsg(Session session, String myAccount, User user) {
        ...
        try {
            //3.1发送方
            message.setFrom(new InternetAddress(myAccount, "小米商城官方邮件", "utf-8"));
            //3.2设置接收方
            /*
            ...
            //3.3 设置主题
            message.setSubject("小米商城激活码", "utf-8");
            //获取本机的ip地址
            String ip = Inet4Address.getLocalHost().getHostAddress();
            String url = "http://" + ip + ":8080/Mall/activate?e=" + Base64Utils.encode(user.getEmail()) + "&c=" + Base64Utils.encode(user.getActivatecode());
            //设置正文信息
